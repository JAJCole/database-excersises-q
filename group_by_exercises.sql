...
/* Write a query to find all unique combinations of first and last names of all employees 
...
select first_name, gender, count(*) as name_gender from employees
where first_name in ('Irena', 'Vidya', 'Maya')
group by first_name, gender
order by name_gender
;
